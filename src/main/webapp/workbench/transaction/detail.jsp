...
<%@ page import="com.yudi.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.yudi.crm.workbench.domain.Tran" %>
...
<script type="text/javascript">
	...
	function changeStage(stage,i) {
        ...
        $.ajax({
            ...
            success:function (data) {
                /*
                * data
                * {"success":true/false，"t":t}
                * */
                if (data.success){
                //    改变阶段成功后，需要再详细页面上局部刷新，刷新阶段，可能性，修改人，修改时间
    ...
    function changIcon(stage,index1) {
	//	当前阶段
		var currentStage = stage;
	//	当前阶段可能性
		var currentPosiibility = $("#possibility").html();
	//	当前阶段下标
		var index = index1;
	//	前面正常阶段和丢失阶段的分界点下标
		var point = "<%=point%>";
		// alert(currentIndex+currentPosiibility+currentStage+point)
		//当前阶段可能性为0，前七个一定是黑圈，后两个一个红叉，一个黑×
		if (currentPosiibility == "0") {
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			if ("0".equals(currentPossibility)){
			    //前七个全是黑圈，后面一个为红叉，一个为黑叉
				for (int i = 0; i < dicValueList.size(); i++){
//				    取得每一个遍历出来的阶段，很具每一个遍历出来的阶段取其可能性
					DicValue dicValue = dicValueList.get(i);
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<div class="remarkDiv" style="height: 60px;">
			...
			<div style="position: relative; top: -40px; left: 40px;" >
				<h5>哎呦！</h5>
				<font color="gray">交易</font> <font color="gray">-</font> <b>交易01</b> <small style="color: gray;"> 2017-01-22 10:10:10 由zhangsan</small>
