...
<script>
	...
	*   08          0
	*
	* 以上数据数据量少，保存在数据库中没有必要，是键值对一一对应的关系使用.properties 属性文件
	* stage2Possibility.properties
	* 中文支持的不好，所以要使用中文转码  "D:\JDK\bin\native2ascii.exe"
	* 需要将该文件解析在服务器缓存中
	* */
    $(function () {
    ...
    //    为阶段下拉框绑定下拉框事件
		...
		//	取得选中的阶段
			...
			* 填写可能性
			* 阶段有了stage
			* 阶段和可能性之间的对应关系pMap，pMap是java中的map
			* 将pMap转换为js中的键值对关系json
			* 要做的事pMap转换为json
			*/
		//	以上已经将json处理好了
			/*
			...
			* 以为stage是一个可变的变量
			* 不能以传统的取值方式
			* var possibility = json.stage;这种形式是错误的
			* */
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
                ...
                <input type="hidden" value="51bbe8a72da341a78106a83e6099fb72" name="activityId"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
                ...
                <input type="hidden" value="6a6dc9ae60454fc287ac2b328d966991" name="contactsId"/>
			</div>
		</div>
