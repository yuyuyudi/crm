                ...
                success:function (data) {
					...
					* */
					...
					//    添加成功，在文本域上方添加一个div
						...
						html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\''+ data.ar.id +'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #63bbe6;"></span></a>';
						html += '&nbsp;&nbsp;&nbsp;&nbsp;';
						//动态生成的必须套在字符串中 错误写法：'+ n.id +'
						html += '<a class="myHref" href="javascript:void(0);" onclick="deleteRemark(\''+ data.ar.id +'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #e64743;"></span></a>';
						html += '</div>';
						html += '</div>';
						html += '</div>';
            ...
            success:function (data) {
				...
				* [{备注1}.{备注2}]*/
				...
				$.each(data,function (i,n) {
					...
					html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
					html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\''+ n.id +'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #63bbe6;"></span></a>';
					html += '&nbsp;&nbsp;&nbsp;&nbsp;';
					//动态生成的必须套在字符串中 错误写法：'+ n.id +'
					html += '<a class="myHref" href="javascript:void(0);" onclick="deleteRemark(\''+ n.id +'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #e64743;"></span></a>';
					html += '</div>';
					html += '</div>';
					html += '</div>';
                })
